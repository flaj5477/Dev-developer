...
<%
String up_url = request.getContextPath()+"/images/qna"; // 기본 업로드 URL
String up_dir = request.getParameter("up_dir")!=null?request.getParameter("up_dir") :"/images/qna";    // 기본 업로드 폴더
